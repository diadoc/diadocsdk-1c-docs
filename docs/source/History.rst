...
- Добавлено значение Type = "ActionRequested" в объект :doc:`ResolutionStatus <ResolutionStatus>`
- Добавленв коллекция доступных действий AvaliableActions в объект :doc:`ResolutionRequest <ResolutionRequest>`
