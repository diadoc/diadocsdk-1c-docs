...
- Добавлена возможность подписания документов облачной подписью:
  - Добавлены свойства: объект DiadocConnection - свойство CloudCertificates (для получения облачных сертификатов пользователя)
  - Добавлены объекты: CloudCertificateInfo (для информации об облачном сертификате),
    CloudSignTask (для задание на подписание документов облачной подписью).
