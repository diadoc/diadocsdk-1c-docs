...
* Для разрегистрации компоненты необходимы права администратора и незанятость компоненты ни одним пользователем (иногда Windows считает компоненту кем-то занятой, даже если все пользователи уже вышли из программ, использующий компоненту)
