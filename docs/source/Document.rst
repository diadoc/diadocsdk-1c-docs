...
--------------
    ...
    -  :doc:`GetDynamicContent <Document_GetDynamicContent>` - получение контента титула отправителя документа в виде :doc:`DynamicContent <DynamicContent>`
    -  :doc:`GetDynamicBuyerContent <Document_GetDynamicBuyerContent>` - получение контента титула поулчателя документа в виде :doc:`DynamicContent <DynamicContent>`
...
1. Свойство **Direction** принимает одно из следующих значений:

    -  "Inbound"  - входящий документ
    -  "Outbound" - исходящий документ
    -  "Internal" - внутренний документ

2. Свойство **RevocationStatus** принимает одно из следующих значений:
...
3. Свойство **RoamingNotificationStatus** принимает одно из следующих значений:
...
4. Свойство **SenderSignatureStatus** принимает одно из следующих значений:
...
5. Свойство **RecipientResponseStatus** принимает одно из следующих значений:
...
6. Следующие объекты являются производными от Document:
...
.. toctree::
   ...
   :hidden:
    ...
    SaveBuyerContent <SaveBuyerContent>
    Approve <Approve>
    ...
    AssignToResolutionRoute <AssignToResolutionRoute>
    RemoveFromResolutionRoute <RemoveFromResolutionRoute>
