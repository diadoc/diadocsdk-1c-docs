...
Объект предназначен для работы с содержанием документов типа "Акт в формате 552-го приказа ФНС"

`Требования к формату передаваемого документа <https://normativ.kontur.ru/document?moduleId=1&documentId=265283>`_
