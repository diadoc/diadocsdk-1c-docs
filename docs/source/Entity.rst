...
-  **CreatedDocumentIds** (:doc:`коллекция строк <ValueCollection>`, чтение) - коллекция идентификаторов документов, созданных из сущности. Присутствует у сущностей, содержащих шаблоны документов
