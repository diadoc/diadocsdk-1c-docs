...
-  :doc:`BasicDocumentContent <BasicDocumentContent>` - содержание акта о выполнении работ в неформализованном виде,
   ТОРГ-12 в неформализованном виде или счета на оплату
...
-  :doc:`OutDocumentSignTaskContent <OutDocumentSignTaskContent>` - содержание запроса на подписание и отправку исходящего документа
...
-  :doc:`XmlDocumentContent <XmlDocumentContent>` - содержание формализованных документов титул исполнителя документа «акт 
