...
:LockMode:
  **строка, чтение/запись** - режим блокировки сообщения. |PackageSendTask2-LockMode|_
...
.. |PackageSendTask2-LockMode| replace:: Возможные значения
.. _PackageSendTask2-LockMode:
