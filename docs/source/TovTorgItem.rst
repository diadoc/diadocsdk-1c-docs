...
- **Gross** (число с плавающей точкой, чтение/запись) - масса брутто

- **Net** (число с плавающей точкой, чтение/запись) - масса нетто, количество передано (отпущено)

- **ItemToRelease** (число, чтение/запись) - Количество надлежит отпустить

- **Price** (число с плавающей точкой, чтение/запись) - цена за единицу товара

- **SubtotalWithVatExcluded** (число с плавающей точкой, чтение/запись) - сумма без учета налога

- **TaxRate** (строка, чтение/запись) - ставка налога

- **Vat** (число с плавающей точкой, чтение/запись) - сумма налога

- **Subtotal** (число с плавающей точкой, чтение/запись) - сумма всего
