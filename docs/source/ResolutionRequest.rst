...
-  AvaliableActions(:doc:`коллекция <ValueCollection>` строк, чтение) - список действий, которые можно выполнить в рамках текущего запроса на согласование
...
В коллекции **AvaliableActions** могут содержаться значения:
