...
* В объект :doc:`../../ComObjects/UсdRevision` добавлены поля **Revised**, **Corrected**, **OriginalDocumentRevisionDate**, **OriginalDocumentRevisionNumber**, **OriginalDocumentCorrectionDate**, **OriginalDocumentCorrectionNumber**
